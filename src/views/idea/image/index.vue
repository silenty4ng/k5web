              ...
              <a-row :gutter="20">
                <a-col :span="4" v-for="i in state.nowpage">
                  <t-card :style="{ width: '100%', marginBottom: '10px' }">
                    <template #cover>
                      <img style="height: 6.75vw;" :title="i.title + ' [' + i.upload + ']'" :src="'https://k6.vicicode.cn/wsapi/download?id=' + i.id + '&n=' + i.title + '.jpg'">
                    </template>
                    <template #footer>
                      <t-row :align="'middle'" justify="center" style="gap: 24px">
                        ...
                        <t-col flex="auto" style="display: inline-flex; justify-content: center">
                          <t-button variant="text" shape="square" @click="useImg('https://k6.vicicode.cn/wsapi/download?id=' + i.id + '&n=' + i.title + '.jpg')">
                            <check-double-icon />
                          </t-button>
                        </t-col>
                      </t-row>

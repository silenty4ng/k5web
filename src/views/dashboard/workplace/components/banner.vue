          ...
          <a-space>
            <a-card hoverable :style="{ width: '340px' }">
              <template #cover>
                ...
                >
                <a class="adimg1" target="_blank" href="https://cloud.tencent.com/act/cps/redirect?redirect=6544&cps_key=4ad4431938f2c80656955c7756081f1b&from=console" style="position: relative; display: block;">
                  <img
                    :style="{ width: '100%', display: 'block', opacity: 0 }"
                    alt="ads"
                    src="/rhino-design-800x450.png"
                  />
                  <img
